...
public class Main
{
    ...
    public static final String subscriptionKey = "361295692ca64143befc1767b673f29f";
    ...
    public static final String uriBase = "http://westeurope.api.cognitive.microsoft.com/vision/v1.0/ocr";
